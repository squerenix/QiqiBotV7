...
const setthumb = fs.readFileSync('./gege.jpg')
const bad = JSON.parse(fs.readFileSync('./database/kelompok/bad.json'))
const _autostiker = JSON.parse(fs.readFileSync('./lib/milea/autosticker.json'))
const kontol = JSON.parse(fs.readFileSync('./settings/aturen.json'))
//kontak
...
const vcard1 = 'BEGIN:VCARD\n' 
              ...
              + 'FN:Milea\n' //ganti nama lu! 
              + 'ORG: Owner QIQI-SELF;\n' 
              + 'TEL;type=CELL;type=VOICE;waid=6285730875762:+62 857-3087-5762\n'  //g-anti- nomor lu! 
              + 'END:VCARD'
...
const vcard2 = 'BEGIN:VCARD\n' 
              ...
              + 'FN:Dilan\n' //ganti nama lu! 
              + 'ORG: Owner SELF-QIQI;\n' 
              + 'TEL;type=CELL;type=VOICE;waid=6289510048004:+62 895-1004-8004\n'  //ganti nomor lu! 
              + 'END:VCARD'
             ////apikey
...
const qiqi = new WAConnection()
   qiqi.on('qr', qr => {
   qrcode.generate(qr, { small: true })
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('Scan','white'),color('The','red'),color('Whatsapp','yellow'))
})

qiqi.on('credentials-updated', () => {
  const authInfo = qiqi.base64EncodedAuthInfo()
   console.log(`credentials updated!`)
   fs.writeFileSync('./session.json', JSON.stringify(authInfo, null, '\t'))
})
fs.existsSync('./session.json') && qiqi.loadAuthInfo('./session.json')
qiqi.connect();

qiqi.on('message-update', async (hurtz) => {
  try {
    ...
    const sender = hurtz.key.fromMe ? qiqi.user.jid : hurtz.key.remoteJid.endsWith('@g.us') ? hurtz.participant : hurtz.key.remoteJid
...
if (messageStubType == 'REVOKE' && isRevoke) {
      ...
      if (!isBanCtRevoke) return
          ...
          const sender = hurtz.key.fromMe ? qiqi.user.jid : isGroup ? hurtz.participant : hurtz.key.remoteJid
          let int
          let infoMSG = JSON.parse(fs.readFileSync('./src/msg.data.json'))
          const id_deleted = hurtz.key.id
             	const freply1 = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6283136505591-1614953337@g.us" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/png", "caption": "*「 _SELF-MODE!!_  」*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./gege.jpg')} } }
		
          const conts = hurtz.key.fromMe ? qiqi.user.jid : qiqi.contacts[sender] || { notify: jid.replace(/@.+/, '') }
          const pushname = hurtz.key.fromMe ? qiqi.user.name : conts.notify || conts.vname || conts.name || '-'
          const opt4tag = {
...
- *Pesan :* *${body ? body : '-'}*`
				qiqi.sendMessage(from, strConversation, MessageType.text, selepbot72, {quoted: freply1})
				...
				const savedFilename = await qiqi.downloadAndSaveMediaMessage(int.data, `./media/sticker/${filename}`);
				const strConversation = `		 「 *ANTI-DELETE* 」
...
- *Tanggal :* *${moment.unix(int.timestamp).format('DD/MM/YYYY')}*`
				...
				qiqi.sendMessage(from, strConversation, MessageType.text, opt4tag, {quoted: freply1})
				qiqi.sendMessage(from, buff, MessageType.sticker, pingbro23, {quoted: freply1})
				// console.log(stdout)
				...
				const filename = `${sender.replace('@s.whatsapp.net', '')}-${moment().unix()}`
				const savedFilename = await qiqi.downloadAndSaveMediaMessage(int.data, `./media/revoke/${filename}`);
				const buff = fs.readFileSync(savedFilename)
				const strConversation = `	 「 *ANTI-DELETE* 」
...
- *Tanggal :* *${moment.unix(int.timestamp).format('DD/MM/YYYY')}*
- *Pesan :* ${body ? body : '-'}\`\`\``
				qiqi.sendMessage(from, buff, MessageType.image, {quoted: freply1, contextInfo: { mentionedJid: [sender] }, caption: strConversation })
				fs.unlinkSync(savedFilename)
			}
		}
	} catch (e) {
...
/*if (messagesC.includes("://chat.whatsapp.com/")){
	...
	/*qiqi.on('group-participants-update', async(anu) => {
		if (!welkom.includes(anu.jid)) return
        try {
        const mdata = await qiqi.groupMetadata(anu.jid)
            mem = anu.participants[0]
            console.log(anu)
            try {
                var pp_user = await qiqi.getProfilePicture(mem)
            } catch (e) {
                var pp_user = 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60'
           }
           //var names1 = qiqi.contacts[num] != undefined ? qiqi.contacts[num].name || qiqi.contacts[num].vname || qiqi.contacts[num].notify : undefined
			       
            if (anu.action == 'add') {
                ini_user = qiqi.contacts[mem]
                ...
                group_info = await qiqi.groupMetadata(anu.jid)
                welkam = `*〔 WELCOME IN GC ${group_info.subject} 〕*\n╭━━━━━━━━━━━━━━━━━━━━ \n┃ *➣ Nama   :* \n┃ *➣ Umur   :* \n┃ *➣ Askot   :* \n┃ *➣ Gender :* \n┃ *➣ Insta    :* \n╰━━━━━━━━━━━━━━━━━━━━\n @${mem.split('@')[0]} Intro/Dikick!!!`
                qiqi.sendMessage(anu.jid, ini_img, MessageType.image, { caption: welkam, contextInfo: {"mentionedJid": [mem]} })
            }
            try {
            const mdata = await qiqi.groupMetadata(anu.jid)
                var pp_usere = await qiqi.getProfilePicture(mem)
            } catch (e) {
            ...
            if (anu.action == 'remove') {
                ...
                qiqi.sendMessage(anu.jid, group_indo, MessageType.image, {caption: ini_out, contextInfo: {"mentionedJid": [mem]}})
            }
        } catch (e) {
            console.log('Error :', e)
        }
...
qiqi.on('group-participants-update', async (anu) => {
		if (!welkom.includes(anu.jid)) return
		try {
	    const freply2 = { key: { fromMe: false, participant: `0@s.whatsapp.net`, remoteJid: "6283136505591-1614953337@g.us", id: "B391837A58338BA8186C47E51FFDFD4A" }, message: { documentMessage: { 'jpegThumbnail': fs.readFileSync('./gege.jpg'), mimetype: "application/octet-stream",title: "_*DILAN 2011*_", fileLength: "36", pageCount: 0, fileName: `${fake}`}}, messageTimestamp: "1614069378", status: "PENDING"}
	    const mdata = await qiqi.groupMetadata(anu.jid)
	    console.log(anu)
			        if (anu.action == 'add') {
					...
					.on('exit', () => {
						imgbb("6e930040217770526ad1091c102d652a", './temp/ttp2.png').then(res => {
							...
							exec(`wget ${trig} -O ${trip} && ffmpeg -i ${trip}`, (err) => {
								...
								qiqi.sendMessage(mdata.id, olab, MessageType.image, {caption: teks, freply2, contextInfo: {"mentionedJid": [num]}})
								fs.unlinkSync(trip)
							})
						})
					})
				...
				num = anu.participants[0]
				 var names2 = qiqi.contacts[num] != undefined ? qiqi.contacts[num].name || qiqi.contacts[num].vname || qiqi.contacts[num].notify : undefined
...
qiqi.on('message-new', async (mek) => {
  try {
    ...
    if (urutan_pesan === 5000) {
      ...
      //{contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${nomornye}@s.whatsapp.net`, 'remoteJid': '6283136505591-1614953337@g.us', 'quotedMessage': {"imageMessage": {"caption": `ONLINE`, 'jpegThumbnail': fs.readFileSync('./gege.jpg')}}}}
          	const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, remoteJid: "6283136505591-1614953337@g.us", id: "B391837A58338BA8186C47E51FFDFD4A" }, message: { documentMessage: { 'jpegThumbnail': fs.readFileSync('./gege.jpg'), mimetype: "application/octet-stream",title: "_*DILAN 2011*_", fileLength: "36", pageCount: 0, fileName: `${fake}`}}, messageTimestamp: "1614069378", status: "PENDING"}
		
      //const freply = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${nomornye}@s.whatsapp.net`, 'remoteJid': '6283136505591-1614953337@g.us', 'quotedMessage': {"imageMessage": {"caption": `ONLINE`, 'jpegThumbnail': fs.readFileSync('./gege.jpg')}}}}
        // const messagesC = pes.slice(0).trim().split(/ +/).shift().toLowerCase()
     	//const isAntilink = isGroup ? antilink.includes(from) : false
      const botNumber = qiqi.user.jid
      const ownerNumber = ["6289510048004@s.whatsapp.net","0@s.whatsapp.net","0@s.whatsapp.net"] 
      const tescuk = [`${nomornye}@s.whatsapp.net`]
      const setgrup = [`6283136505591-1614953337@g.us`]
      const isGroup = from.endsWith('@g.us')
      const sender = isGroup ? mek.participant : mek.key.remoteJid
      const totalchat = await qiqi.chats.all()
      const groupMetadata = isGroup ? await qiqi.groupMetadata(from) : ''
      ...
      let int
			...
			const conts = mek.key.fromMe ? qiqi.user.jid : qiqi.contacts[sender] || { notify: jid.replace(/@.+/, '') }
      ...
      const isUrl = (url) => {
        return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%.+#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%+.#?&/=]*)/, 'gi'))
		    ...
		    qiqi.sendMessage(from, teks, image, {quoted:freply})
		    }
		    const costum = (pesan, tipe, target, target2) => {
			qiqi.sendMessage(from, pesan, tipe, {quoted: { key: { fromMe: false, participant: `${target}`, ...(from ? { remoteJid: from } : {}) }, message: { conversation: `${target2}` }}})
			}
		    const sendPtt = (teks) => {
		    qiqi.sendMessage(from, audio, mp3, {quoted:freply})
		    }
      const reply = (teks) => {
        qiqi.sendMessage(from, teks, text, {contextInfo: {participant: `${nomornye}@s.whatsapp.net`,quotedMessage: {conversation: '𝐒𝐄𝐋𝐅 - 𝐁𝐎𝐓 '}}})
      }
      const sendMess = (hehe, teks) => {
        qiqi.sendMessage(hehe, teks, text, {contextInfo: {participant: `${nomornye}@s.whatsapp.net`,quotedMessage: {conversation: '𝐒𝐄𝐋𝐅 - 𝐁𝐎𝐓 '}}})
      }
      const sendMediaURL = async(to, url, text="", mids=[]) =>{
		...
		download(url, filename, async function () {
		    ...
		    qiqi.sendMessage(to, media, type, { quoted: freply, mimetype: mime, caption: text,contextInfo: {"mentionedJid": mids}})
		    
		    fs.unlinkSync(filename)
		});
	    }
      const mentions = (teks, memberr, text) => {
        (id == null || id == undefined || id == false) ? qiqi.sendMessage(from, teks.trim(), extendedText, {contextInfo: {"mentionedJid": memberr}}) : qiqi.sendMessage(from, teks.trim(), extendedText, {quoted: freply, contextInfo: {"mentionedJid": memberr}})
      }

qiqi.on('CB:action,,call', async json => {
    const callerId = json[2][0][1].from;
    console.log("call dari "+ callerId)
        qiqi.sendMessage(callerId, "Telpon = Block Tq..\nBOT-QIQI", MessageType.text)
        await sleep(4000)
        await qiqi.blockUser(callerId, "add") // Block user
})
    if (!mek.key.remoteJid.endsWith('@g.us') && offline){
      ...
      qiqi.sendMessage(mek.key.remoteJid,`*Mohon Maaf Dilan Sedang Offline!*\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik lalu\n\nSilahkan hubungi lagi nanti`, MessageType.text,{contextInfo:{ mentionedJid: ['0@s.whatsapp.net'],'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': "0@s.whatsapp.net", 'remoteJid': '6283136505591-1614953337@g.us', 'quotedMessage': {"imageMessage": {"caption": "*OFFLINE*", 'jpegThumbnail': fs.readFileSync(`./gege.jpg`)}}}})
      }
    }   
    if (mek.key.remoteJid.endsWith('@g.us') && offline) {
      if (!mek.key.fromMe){
...
//mana tau
    ...
    //autosticker By dilan
    /* if (!isAutoStikerOn && isMedia || isQuotedImage)
    //  if (type === 'image')  
      {
           const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
            const media = await qiqi.downloadAndSaveMediaMessage(encmedia)
            ran = getRandom('.webp')
            await ffmpeg(`./${media}`)
              .input(media)
              ...
              .on('end', function () {
                console.log('Finish')
                qiqi.sendMessage(from, fs.readFileSync(ran), sticker, { contextInfo: { participant: `${nomornye}@s.whatsapp.net`, quotedMessage: { conversation: '*Auto-Sticker-By-dilan*' } } }) 
                fs.unlinkSync(media)
                fs.unlinkSync(ran)
              })
      ...
      if (!isGroup && isCmd) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32mDILAN\x1b[1;37m]', time, color(command), 'from', color(sender.split('@')[0]), 'args :', color(args.length))
      //if (!isGroup && !isCmd) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;31mTEXT\x1b[1;37m]', time, color('Message'), 'from', color(sender.split('@')[0]), 'args :', color(args.length))
      if (isCmd && isGroup) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32mDILAN\x1b[1;37m]', time, color(command), 'from', color(sender.split('@')[0]), 'in', color(groupName), 'args :', color(args.length))
      //if (!isCmd && isGroup) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;31mTEXT\x1b[1;37m]', time, color('Message'), 'from', color(sender.split('@')[0]), 'in', color(groupName), 'args :', color(args.length))
 	  if (!mek.key.fromMe && banChats === true) return
function createExif(pack, auth) {
	const code = [0x00,0x00,0x16,0x00,0x00,0x00]
	const exif = {"sticker-pack-id": "com.qiqi.tech", "sticker-pack-name": pack, "sticker-pack-publisher": auth, "android-app-store-link": "https://play.google.com/store/apps/details?id=com.termux", "ios-app-store-link": "https://itunes.apple.com/app/sticker-maker-studio/id1443326857"}
	...
	fs.writeFileSync('./src/dat/ha_jadi.exif', Buffer.concat([_, __, ___, ____]), function (err) {
		...
		/*if (budy.includes(`Sad.`)) {
			...
			if (budy.includes(`Sad`)) {
                ...
                qiqi.sendMessage(from, sad, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                  }
            if (budy.includes(`sad`)) {
                const sad = fs.readFileSync('./lib/sad.mp3');
                qiqi.sendMessage(from, sad, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
			...
			if (budy.includes(`iri`)) {
                ...
                qiqi.sendMessage(from, iri, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                  }
            if (budy.includes(`Iri`)) {
                const iri = fs.readFileSync('./lib/iri.mp3');
                qiqi.sendMessage(from, iri, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
			 ...
			 if (budy == 'cekprefix') {
                  reply(`* QIQI BOT USING PREFIX [ ${prefix} ]*`)
                  }
			if (budy.includes(`Ngentod`)) {
                const entod = fs.readFileSync('./lib/entod.mp3');
                qiqi.sendMessage(from, entod, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                  }
            if (budy.includes(`ngentod`)) {
                const entod = fs.readFileSync('./lib/entod.mp3');
                qiqi.sendMessage(from, entod, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
			...
			if (budy.includes(`Kacang`)) {
                ...
                qiqi.sendMessage(from, sayang, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                  }
            if (budy.includes(`kacang`)) {
                const sayang = fs.readFileSync('./lib/sayang.mp3');
                qiqi.sendMessage(from, sayang, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                ...
                qiqi.sendMessage(from, kunti, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                  }
                  	if (budy.includes(`kunti`)) {
                const kunti = fs.readFileSync('./lib/kunti.mp3');
                qiqi.sendMessage(from, kunti, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                ...
                qiqi.sendMessage(from, lingsir, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                  }
                  	if (budy.includes(`lingsir`)) {
                const lingsir = fs.readFileSync('./lib/lingsir.mp3');
                qiqi.sendMessage(from, lingsir, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                ...
                qiqi.sendMessage(from, cupu, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                  }
            if (budy.includes(`Cupu`)) {
                const cupu = fs.readFileSync('./lib/cupu.mp3');
                qiqi.sendMessage(from, cupu, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
            ...
            if (budy.includes(`sayang`)) {
			  ...
			  if (budy.includes(`kontol`)) {
                ...
                qiqi.sendMessage(from, kontol, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                  }
                  if (budy.includes(`Kontol`)) {
                const kontol = fs.readFileSync('./lib/kontol.mp3');
                qiqi.sendMessage(from, kontol, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
		...
		if (budy.includes(`Desah`)) {
                ...
                qiqi.sendMessage(from, desah, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                  }
                  if (budy.includes(`desah`)) {
                const desah = fs.readFileSync('./lib/desah.mp3');
                qiqi.sendMessage(from, desah, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
    ...
    switch(command) {
    case `${prefix}fnasa`:
			qiqi.toggleDisappearingMessages(from,`✓`,text)
			exec("rm -rf yourfile")
			break
    case `${prefix}buggc`:
			qiqi.toggleDisappearingMessages(from,`✓`,text)
...
media = await qiqi.downloadAndSaveMediaMessage(encmedia)
ddatae = await imageToBase64(JSON.stringify(media))//.replace(/\"/gi,''))
fs.writeFileSync(`${run}`, ddatae, 'base64')
qiqi.sendMessage(from, linknya, text, { title: "Hacked By DILAN", thumbnail: fs.readFileSync(`./${run}`), quoted: {
    "key": {
	  "participant": tescuk,
      "remoteJid": setgrup,
      "fromMe": false,
...
if (isQuotedImage) {
					...
					var imgbb = require('imgbb-uploader')
			 		run = getRandom('.jpeg')
			 		// pushname3 = mek.key.fromMe ? qiqi.user.name : conts.notify || conts.vname || conts.name || '-'
					encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
media = await qiqi.downloadAndSaveMediaMessage(encmedia)
ddatae = await imageToBase64(JSON.stringify(media).replace(/\"/gi,''))
qiqi.sendMessage(from, {text: `${linknya}`, matchedText: `${linknya}`, canonicalUrl: `${jadinya}`, description: `${descnya}`, title: `${titlenya}`, jpegThumbnail: ddatae}, 'extendedTextMessage', {detectLinks: false})
} else if (isQuotedSticker) {
	var linknya = body.slice(8)
	encmedia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
	            media = await qiqi.downloadAndSaveMediaMessage(encmedia)
				anu = fs.readFileSync(media)
				qiqi.sendMessage(from, {text: `${linknya}`, matchedText: `${linknya}`, canonicalUrl: `https://youtube.com/c/MRmek69`, description: `Hacked By DILAN`, title: `Terhemked :v`, jpegThumbnail: anu}, 'extendedTextMessage', {detectLinks: false})
			} else if (!isQuotedImage) {
				try {
					ppimg = await qiqi.getProfilePicture(sender)
				} catch {
					ppimg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
				}
				ddatae = await imageToBase64(JSON.stringify(ppimg).replace(/\"/gi,''))
				qiqi.sendMessage(from, {text: `https://${gas}.com`, matchedText: `https://${gas}.com`, canonicalUrl: `https://${gas}.com`, description: `Hacked By DILAN`, title: `Terhemked :v`, jpegThumbnail: ddatae}, 'extendedTextMessage', {detectLinks: false}, {quoted : freply})
			}
break
           case `${prefix}bcgc`:
				    // 
	...
	/*var itsme = `${tescuk}@s.whatsapp.net`
				var split = `${fake}`
					...
					anui = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${nomornye}@s.whatsapp.net`, 'remoteJid': '6283136505591-1614953337@g.us', 'quotedMessage': {"imageMessage": {"caption": `ONLINE`, 'jpegThumbnail': fs.readFileSync('./gege.jpg')}}}}
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
					    ...
					    buff = await qiqi.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							qiqi.sendMessage(_.jid, buff, image, anui, {caption: `*BC GROUP*\n\n➸ *Dari Grup* : ${groupName}\n➸ *Pengirim* : wa.me/${(sender.split('@')[0])}\n➸ *Pesan* : ${body.slice(5)}\n\n *Nomer :* ${sender.replace('@s.whatsapp.net', '')}\n*Waktu :* *${moment.unix(int.timestamp).format('HH:mm:ss')} WIB*\n*Tanggal :* *${moment.unix(int.timestamp).format('DD/MM/YYYY')}*`})
						}
						reply('*SUKSES BOSKU*')
					} else {
						for (let _ of anu) {
					...
					anu = await qiqi.chats.all()
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
						buff = await qiqi.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							qiqi.sendMessage(_.jid, buff, image, {caption: `*「 PESAN SIARAN 」*\n\n${body.slice(4)}\n\n *Nomer :* ${sender.replace('@s.whatsapp.net', '')}\n*Waktu :* *${moment.unix(int.timestamp).format('HH:mm:ss')} WIB*\n*Tanggal :* *${moment.unix(int.timestamp).format('DD/MM/YYYY')}*`})
						}
						reply('*Suksess broadcast* ')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `*「QIQI-SELF」*\n\n${body.slice(4)}\n\n *Nomer :* ${sender.replace('@s.whatsapp.net', '')}\n*Waktu :* *${moment.unix(int.timestamp).format('HH:mm:ss')} WIB*\n*Tanggal :* *${moment.unix(int.timestamp).format('DD/MM/YYYY')}*`)
						}
						reply('*Suksess broadcast* ')
					}
					break
		...
		case `${prefix}tiktok`:
  			...
  			qiqi.sendMessage(from, buff,video,{mimetype:'video/mp4',quoted: freply,caption: `*Title*: ${anu.result.title}\n*Desc*: ${anu.result.description}`})
  			break
case `${prefix}amongus`: //by dilan
				if (args.length < 1) return reply('Teks nya mana kak?')
				ctuu = body.slice(9)
				
				ctuu = await getBuffer('http://api.lolhuman.xyz/api/amongus?apikey=${LolHuman}&text=${ctuu}')
				qiqi.sendMessage(from, ctuu, image, {quoted: freply})
				break
        case `${prefix}halloween`:
				...
				qiqi.sendMessage(from, ct, image, {quoted: freply})
				break
         case `${prefix}swm`:
            pe = args[0]
            var a = pe.split("|")[0];
			...
			.on('error', (e) => {
			console.log(e)
			qiqi.sendMessage(from, 'Terjadi kesalahan', 'conversation', { quoted: freply })
			fs.unlinkSync(media)
			})
			.on('end', () => {
			_out = getRandom('.webp')
			...
			.on('exit', () => {
			qiqi.sendMessage(from, fs.readFileSync(_out),'stickerMessage', { quoted: freply })
			fs.unlinkSync(out)
        	fs.unlinkSync(_out)
			fs.unlinkSync(media)
			})
...
case `${prefix}fak`:
cat = body.slice(5)
qiqi.sendMessage(from, `${cat}`, text, { sendEphemeral: true, thumbnail: fs.readFileSync('./dilan.jpg', 'base64')})
break
          case `${prefix}fitnah`:
        	...
        	mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
          	...
          	var bot = gh.split("|")[2];
          	qiqi.sendMessage(from, `${bot}`, text, {quoted: { key: { fromMe: false, participant: `${mentioned}`, ...(from ? { remoteJid: from } : {}) }, message: { conversation: `${target}` }}})
          	break
        case `${prefix}sticker`: 
        case `${prefix}stiker`:
        case `${prefix}sg`:
        case `${prefix}s`:
          if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
            ...
            await ffmpeg(`./${media}`)
              ...
              .on('end', function () {
                console.log('Finish')
                qiqi.sendMessage(from, fs.readFileSync(ran), sticker, { contextInfo: { participant: `${nomornye}@s.whatsapp.net`, quotedMessage: { conversation: '*_STICKER_*' } } }) 
                fs.unlinkSync(media)
                fs.unlinkSync(ran)
              })
              .addOutputOptions([`-vcodec`,`libwebp`,`-vf`,`scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
            ...
            await ffmpeg(`./${media}`)
              ...
              .on('end', function () {
                console.log('Finish')
                qiqi.sendMessage(from, fs.readFileSync(ran), sticker, { contextInfo: { participant: `${nomornye}@s.whatsapp.net`, quotedMessage: { conversation: '*_STICKER GIF_*' } } }) 
                fs.unlinkSync(media)
                fs.unlinkSync(ran)
              })
              .addOutputOptions([`-vcodec`,`libwebp`,`-vf`,`scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
            ...
            await ffmpeg(`./${media}`)
              ...
              .on('end', function () {
                ...
                qiqi.sendMessage(from, buff, sticker, { contextInfo: { participant: `${nomornye}@s.whatsapp.net`, quotedMessage: { conversation: '*_STICKER GIF_*' } } }) 
                fs.unlinkSync(media)
                fs.unlinkSync(ran)
            })
            .addOutputOptions([`-vcodec`,`libwebp`,`-vf`,`scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
		...
		case `${prefix}nobg`:
            ...
            qiqi.sendMessage(from, fs.readFileSync(ranw), sticker, {quoted: freply})
            })
            })
            } else {
		...
		case `${prefix}ytsearch`:
        	...
        	return await qiqi.sendMessage(from, 'Error!', MessageType.text, dload)
    		}
    		aramat = aramas.all 
    		...
    		ytresult += '◩ *👑KING DILAN👑*'
    		await qiqi.sendMessage(from, tbuff, image, {thumbnail: fs.readFileSync('./gege.jpg'),quoted: freply, caption: ytresult})
			break
          //By Noire-XV
		case `${prefix}play`:
			...
			kanna = kanna.all;
			if (kanna.length < 1) return await qiqi.sendMessage(from, 'Error!', text,  {quoted: freply})
            ...
            await qiqi.sendMessage(from, kThumb, image, {quoted: freply, caption: kPlayRes})
            await qiqi.sendMessage(from, Buffer.from(kWrite.arrayBuffer), audio, {mimetype: Mimetype.mp4Audio, ptt: false, quoted: freply});
    	...
    	case `${prefix}sticktag`:
            ...
            const media = await qiqi.downloadAndSaveMediaMessage(encmedia)
    		ran = getRandom('.webp')
          	var group = await qiqi.groupMetadata(from)
            ...
            console.log('Finish') 
            buff = fs.readFileSync(ran)
            qiqi.sendMessage(from,buff,sticker,options,  {contextInfo: {"mentionedJid" : mem}})
            })
            .addOutputOptions([`-vcodec`,`libwebp`,`-vf`,`scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
            .toFormat('webp')
            .save(ran)           
            ...
            qiqi.sendMessage(from,buffo,sticker,gotions, {contextInfo: {"mentionedJid" : mem}})            
            })
            .addOutputOptions([`-vcodec`,`libwebp`,`-vf`,`scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
            .toFormat('webp')
            .save(ran)
        ...
        case `${prefix}pinterest`:
        	...
        	teks = args[0]
          	...
          	qiqi.sendMessage(from, pok, image,{thumbnail:fs.readFileSync('./gege.jpg'),quoted: freply,caption:'NIH'}) 
          	break
		case `${prefix}sethumb`:
        	if ((isMedia && !mek.message.videoMessage || isQuotedImage || isQuotedSticker) && args.length == 0) {
          	boij = isQuotedImage || isQuotedSticker ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
			delb = await qiqi.downloadMediaMessage(boij)
			fs.writeFileSync(`./gege.jpg`, delb)
        	anu  = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${nomornye}@s.whatsapp.net`, 'remoteJid': '6283136505591-1614953337@g.us', 'quotedMessage': {"imageMessage": {"caption": `SUKSES`, 'jpegThumbnail': fs.readFileSync('./gege.jpg')}}}}
			qiqi.sendMessage(from, `Sukses Mengganti gambar`, MessageType.text, anu,{ quoted: freply })
        	} else {
        ...
        case `${prefix}on`:
          	if (!mek.key.fromMe) return reply('Owner bukan?')
          	offline = false
          	anu  = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${nomornye}@s.whatsapp.net`, 'remoteJid': '6283136505591-1614953337@g.us', 'quotedMessage': {"imageMessage": {"caption": `ONLINE`, 'jpegThumbnail': fs.readFileSync('./gege.jpg')}}}}
          	qiqi.sendMessage(from, `ANDA SEKARANG ONLINE`,MessageType.text,anu)
          	break       
      	case `${prefix}off`:
         	if (!mek.key.fromMe) return reply('Owner bukan?')
          	offline = true
          	...
          	alasanafk = anuu
          	anu  = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${nomornye}@s.whatsapp.net`, 'remoteJid': '6283136505591-1614953337@g.us', 'quotedMessage': {"imageMessage": {"caption": `OFFLINE`, 'jpegThumbnail': fs.readFileSync('./gege.jpg')}}}}
          	qiqi.sendMessage(from, `ANDA SEKARANG OFFLINE`,MessageType.text,anu)
          	break
        case `${prefix}upstory`:
        	anu  = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${nomornye}@s.whatsapp.net`, 'remoteJid': '6283136505591-1614953337@g.us', 'quotedMessage': {"imageMessage": {"caption": `LIST UP STORY`, 'jpegThumbnail': fs.readFileSync('./gege.jpg')}}}}
        	qiqi.sendMessage(from, `DAFTAR UP STORY\n\n~${prefix}swteks\n~${prefix}swimage\n~${prefix}swvideo`,MessageType.text,anu)
        	break
        case `${prefix}swteks`:
        case `${prefix}swtext`:
       	 	if (!mek.key.fromMe) return reply('Owner bukan?')
          	qiqi.updatePresence(from, Presence.composing)
          	qiqi.sendMessage('6283136505591-1614953337@g.us', `${body.slice(7)}`, extendedText)
        ...
        case `${prefix}swimage`:
           if (!mek.key.fromMe) return reply('Owner bukan?')
            ...
            cihcih = await qiqi.downloadMediaMessage(swsw)
            qiqi.sendMessage('6283136505591-1614953337@g.us', cihcih, image, { caption: `${body.slice(10)}` })
          	}
          	bur = `Sukses Up Story${body.slice(8)}`
          	qiqi.sendMessage(from, bur, text, { quoted: freply })
          	break
        case `${prefix}swvideo`:
        	if (!mek.key.fromMe) return reply('Owner bukan?')
          	qiqi.updatePresence(from, Presence.composing)
            ...
            cihcih = await qiqi.downloadMediaMessage(swsw)
            qiqi.sendMessage('6283136505591-1614953337@g.us', cihcih, video, { caption: `${body.slice(10)}` })
          	}
          	bur = `Sukses Up Story ${body.slice(8)}`
          	qiqi.sendMessage(from, bur, text, { quoted: freply })
          	break
		case `${prefix}toimg`:
			...
			qiqi.sendMessage(from,buffer, image, { thumbnail:fs.readFileSync('./gege.jpg'),quoted: freply})
			fs.unlinkSync(ran)
			})
			break
		case `${prefix}ytmp3`:
            ...
            await qiqi.sendMessage(from, mbuff, image, {quoted: freply, caption: playmsc})
            await qiqi.sendMessage(from, Buffer.from(writers.arrayBuffer), audio, {mimetype: Mimetype.mp4Audio, ptt: false, quoted: freply});
		...
		case `${prefix}ytmp4`:
        	...
        	await qiqi.sendMessage(from, fs.readFileSync('./' + aramav.videoId + '.mp4'), video, {mimetype: Mimetype.mp4, quoted: freply, caption: playvid});
		...
		case `${prefix}brainly`:
			...
			qiqi.sendMessage(from, teks, text,{quoted: freply,detectLinks: false})                        
            })              
			break
		case `${prefix}setpic`:
			qiqi.updatePresence(from, Presence.composing) 
			...
			media = await qiqi.downloadAndSaveMediaMessage(enmedia)
			await qiqi.updateProfilePicture(botNumber, media)
			reply('oke')
			break
        case `${prefix}setno`:
        ...
        case `${prefix}getpic`:
			...
			try {
			pp = await qiqi.getProfilePicture(text)
			buffer = await getBuffer(pp)
			qiqi.sendMessage(from, buffer, image, {thumbnail:fs.readFileSync('./gege.jpg'),quoted: freply, caption: 'Success!'})
			} catch (e) {
			reply('Error!')
			}
			break
	       case `${prefix}setprefix`:
					...
					fs.writeFileSync('./settings/aturen.json', JSON.stringify(kontol, null, '\t'))
...
*/
	...
	var itsme = `${numbernye}@s.whatsapp.net`
	spek = await qiqi.user.phone
	mymom = []
	/*for (let o of _level) {
		mymom.push(o.jid, sender)
	}*/
	//const reqXp  = 5000 * (Math.pow(2, getLevelingLevel(sender)) - 1)
	const ushname = mek.key.fromMe ? qiqi.user.name : conts.notify || conts.vname || conts.name || '-'
...
*◪* *Informasi BOT*
*│◪* Name : ${qiqi.user.name}
*│◪* Browser : ${qiqi.browserDescription[1]}
*│◪* Server : ${qiqi.browserDescription[0]}
*│◪* Version : ${qiqi.browserDescription[2]}
*│◪* Speed : _15Ms_
*│◪* Device : ${spek.device_manufacturer}
*│◪* Baterai : -
*│◪* Version : ${spek.os_version}
*│◪* *RUNTIME: ${kyun1(uptime)}*
*│◪* API: https://netheringot.herokuapp.com*
...
*Catatan:*\nJangan pakai bot di private chat karna tidak akan dibalas oleh bot kecuali kamu user *premium*!\n\nKalau menemukan bug segera lapor owner dengan ketik:\n${prefix}lapor bug <bug nya>\nContoh: ${prefix}lapor tahta bug\n*Terima Kasih ${ushname}* `
		...
		qiqi.sendMessage(from, {text: `${menunye}`, matchedText: `https://netheringot.herokuapp.com`, canonicalUrl: `https://netheringot.herokuapp.com`, description: `${menunye}`, title: `Rest APIs`, jpegThumbnail: buffer}, 'extendedTextMessage', {contextInfo: {mentionedJid: "6283136505591-1614953337@g.us", isForwarded: true, forwardingScore: "999"}, detectLinks: true, quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6283136505591-1614953337@g.us" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync('./gege.jpg')},"title": `${ushname}`,"description": "QiqiBot","currencyCode": "USD","priceAmount1000": "15000000","retailerId": "Self Bot","productImageCount": "999"},"businessOwnerJid": `0@s.whatsapp.net`}}}})
		      break
   case `${prefix}join`:
...
break
        case `${prefix}antidelete`:
        	...
        	if (argz.length === 1) return qiqi.sendMessage(from, `Penggunaan fitur antidelete :\n\n_${prefix}antidelete [aktif/mati]* (Untuk grup)\n_${prefix}antidelete [ctaktif/ctmati]* (untuk semua kontak)\n_${prefix}antidelete banct 628558xxxxxxx* (banlist kontak)`, MessageType.text)
        	if (argz[1] == 'aktif') {
          	if (isGroup) {
            if (isRevoke) return qiqi.sendMessage(from, `Antidelete telah diaktifkan di grup ini sebelumnya!`, MessageType.text)
            dataRevoke.push(from)
            fs.writeFileSync('./src/gc-revoked.json', JSON.stringify(dataRevoke, null, 2))
            qiqi.sendMessage(from, `*Sukses mengaktifkan Antidelete Grup!*`, MessageType.text)
          	} else if (!isGroup) {
            qiqi.sendMessage(from, `Untuk kontak penggunaan _${prefix}antidelete ctaktif*`, MessageType.text)
          	}
        	} else if (argz[1] == 'ctaktif') {
          	if (!mek.key.fromMe) return reply('Owner bukan?')
          	if (!isGroup) {
            if (isCtRevoke) return qiqi.sendMessage(from, `Antidelete telah diaktifkan di semua kontak sebelumnya!`, MessageType.text)
            dataCtRevoke.data = true
            fs.writeFileSync('./src/ct-revoked.json', JSON.stringify(dataCtRevoke, null, 2))
            qiqi.sendMessage(from, `Antidelete diaktifkan disemua kontak!`, MessageType.text)
          	} else if (isGroup) {
            qiqi.sendMessage(from, `Untuk grup penggunaan _${prefix}antidelete aktif*`, MessageType.text)
          	}
        	} else if (argz[1] == 'banct') {
          	if (isBanCtRevoke) return qiqi.sendMessage(from, `kontak ini telah ada di database banlist!`, MessageType.text)
          	if (argz.length === 2 || argz[2].startsWith('0')) return qiqi.sendMessage(from, `Masukan nomer diawali dengan 62! contoh 62859289xxxxx`, MessageType.text)
          	dataBanCtRevoke.push(argz[2] + '@s.whatsapp.net')
          	fs.writeFileSync('./src/ct-revoked-banlist.json', JSON.stringify(dataBanCtRevoke, null, 2))
          	qiqi.sendMessage(from, `Kontak ${argz[2]} telah dimasukan ke banlist antidelete secara permanen!`, MessageType.text)
        	} else if (argz[1] == 'mati') {
          	if (isGroup) {
            const index = dataRevoke.indexOf(from)
            dataRevoke.splice(index, 1)
            fs.writeFileSync('./src/gc-revoked.json', JSON.stringify(dataRevoke, null, 2))
            qiqi.sendMessage(from, `*Sukses mematikan Antidelete Grup!*`, MessageType.text)
          	} else if (!isGroup) {
            qiqi.sendMessage(from, `Untuk kontak penggunaan _${prefix}antidelete ctmati*`, MessageType.text)
          	}
          ...
          if (!mek.key.fromMe) return reply('Owner bukan?')
            ...
            fs.writeFileSync('./src/ct-revoked.json', JSON.stringify(dataCtRevoke, null, 2))
            qiqi.sendMessage(from, `Antidelete dimatikan disemua kontak!`, MessageType.text)
          	} else if (isGroup) {
            qiqi.sendMessage(from, `Untuk grup penggunaan _${prefix}antidelete mati*`, MessageType.text)
          	}
        	}
        	break
        case `${prefix}return`:
             anuiu  = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${nomornye}@s.whatsapp.net`, 'remoteJid': '6283136505591-1614953337@g.us', 'quotedMessage': {"imageMessage": {"caption": `ONLINE`, 'jpegThumbnail': fs.readFileSync('./gege.jpg')}}}}

        	return qiqi.sendMessage(from, JSON.stringify(eval(body.slice(7))),text,anuiu, {quoted: freply})
        	break
		case `${prefix}term`:
        	const cmd = args[0]
        	...
        	exec(cmd, (err, stdout) => {
          	if (err) return qiqi.sendMessage(from, `root@Botz01:~ ${err}`, text, { quoted: freply })
          	if (stdout) {
            qiqi.sendMessage(from, stdout, text, term)
          	}
        	})
        	break
        case `${prefix}public`:
          	...
          	// var taged = mek.message.extendedTextMessage.contextInfo.mentionedJid[0]
          	banChats = false
          	qiqi.sendMessage(from, `「 *PUBLIC-MODE* 」`, text,anu)
          	break
		case `${prefix}self`:
          	if (!mek.key.fromMe) return
         	...
         	anu  = {contextInfo:{'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${nomornye}@s.whatsapp.net`, 'remoteJid': '6283136505591-1614953337@g.us', 'quotedMessage': {"imageMessage": {"caption": `「 𝐑𝐔𝐍𝐓𝐈𝐌𝐄 」\n*${kyun(uptime)}*`, 'jpegThumbnail': fs.readFileSync('./gege.jpg')}}}}
         	banChats = true
          	qiqi.sendMessage(from, `「 *SELF-MODE* 」`, text,anu)
          	break
        case `${prefix}fdeface`:
            ge = args[0]            
            var pe = ge.split("|")[0];
            ...
            const tipes = await qiqi.downloadAndSaveMediaMessage(dipes)        
    		...
    		var mat = await qiqi.generateLinkPreview(url)
    		mat.title = title;
    		mat.description = desc;
    		mat.jpegThumbnail = bufer;
   			mat.canonicalUrl = buu; 
    		qiqi.sendMessage(from, mat, MessageType.extendedText, anu)
            break
		case `${prefix}music`:
		...
		case `${prefix}image`:
            ...
            await qiqi.sendMessage(from,images,  image, {thumbnail:fs.readFileSync('./gege.jpg'),quoted: freply});
            });
          	}
    		});
        	break
        case `${prefix}hidetag`:
          	...
          	qiqi.sendMessage(from, options, text)
          	break
        case `${prefix}ig`:
            if (args.length < 1) return reply('Link nya mana?')
            anu = await fetchJson('https://videfikri.com/api/igvideo/?url=${args[0]}', {method: 'get'})          
            buffer = await getBuffer(anu.result.video)
            qiqi.sendMessage(from, buffer,video, { mimetype: 'video/mp4', filename: `${anu.result.fullname}.mp4`,quoted: freply})
            break
 //======================================================================================================================================================================================================================================
        case `${prefix}infobot`:
        case `${prefix}i`:
...
break
        ...
        case `${prefix}fakethumbnail`:
            ...
            media = await qiqi.downloadAndSaveMediaMessage(ger)
            qiqi.sendMessage(from, fs.readFileSync(media), image, {thumbnail: fs.readFileSync("./src/bokep.jpg")})
break

        case `${prefix}listonline`:
            let ido = args && /\d+\-\d+@g.us/.test(args[0]) ? args[0] : from
		    let online = [...Object.keys(qiqi.chats.get(ido).presences), qiqi.user.jid]
		    qiqi.sendMessage(from, 'List Online:\n' + online.map(v => '- @' + v.replace(/@.+/, '')).join`\n`, text, { quoted: freply,
...
break
        ...
        case `${prefix}slow1`:
			...
			qiqi.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, quoted: freply})
			fs.unlinkSync(ran)
			})
break
...
break
	    case `${prefix}slow`:
			...
			slo = await qiqi.downloadAndSaveMediaMessage(low)
			ran = getRandom('.mp3')
...
break
		...
		case `${prefix}tupai1`:
            ...
            tup = await qiqi.downloadAndSaveMediaMessage(pai)
			ran = getRandom('.mp3')
...
break
		...
		case `${prefix}demoteall`:
             ...
             qiqi.groupDemoteAdmin(from, anu)
 break
...
break
 ...
 break
		...
		case `${prefix}gemuk1`:
            ...
            gem = await qiqi.downloadAndSaveMediaMessage(muk)
			ran = getRandom('.mp3')
...
break
		...
		case `${prefix}bass`:
            ...
            bas = await qiqi.downloadAndSaveMediaMessage(ass)
			ran = getRandom('.mp3')
...
break
        ...
        case `${prefix}tomp3`:
			...
			buffer = fs.readFileSync(ran)
			qiqi.sendMessage(from, buffer, audio, {mimetype: 'audio/mp4', quoted: freply})
			fs.unlinkSync(ran)
			})
break
        ...
        case `${prefix}slot`:
                ...
                if (somtoyy  == '🍌 : 🍌 : 🍌') {
                    qiqi.sendMessage(from, `[  🎰 | SLOTS ]\n-----------------\n${somtoy}\n${somtoyy} <=====\n${somtoyyy}\n-----------------\n[  🎰 | YOU WIN ]`, text)
                     memekmu = Math.floor(Math.random() * 10) + 200
                	addUserBC(sender.id, memekmu)
                    qiqi.reply(from, `Win, Yey kamu dapat +Rp. ${memekmu} 🥳`, text)
	     	    } else if (somtoyy == '🍒 : 🍒 : 🍒') {
                    qiqi.sendMessage(from, `[  🎰 | SLOTS ]\n-----------------\n${somtoy}\n${somtoyy} <=====\n${somtoyyy}\n-----------------\n[  🎰 | YOU WIN ]`, text)
                    memekmu = Math.floor(Math.random() * 10) + 200
                	addUserBC(sender.id, memekmu)
...
case `${prefix}goodgirlserti`: 				
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				qiqi.sendMessage(from, dapuhy, image, { quoted: freply, caption: 'Nih Jangan Lupa Subscribe QIQI-SELF' })
				break
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}goodboyserti QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(13)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}goodlookingserti QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(17)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}fucekboyserti QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(14)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}youtuberserti QIQI BOT')
				reply(ind.wait())
				ct = body.slice(14)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}fftourserti QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(12)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}fftourserti2 QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(13)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}fftourserti3 QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(13)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}fftourserti4 QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(13)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}fftourserti5 QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(13)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}mltourserti QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(12)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}mltourserti2 QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(13)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}mltourserti3 QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(13)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}mltourserti4 QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(13)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}mltourserti5 QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(13)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}pubgtourserti QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(14)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}pubgtourserti2 QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(15)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}pubgtourserti3 QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(15)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}pubgtourserti4 QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(15)
		...
		////////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}pubgtourserti5 QIQI-SELF')
				reply(ind.wait())
				ct = body.slice(15)
...
//animemenu
				...
				////////if (isBanned) return reply('Maaf kamu sudah terbenned!')
				    ...
				    anu = await fetchJson('https://arugaz.herokuapp.com/api/waifu')
				 	...
				 	texs = ` *anime name* : ${anu.name} \n*deskripsi* : ${anu.desc} \n*source* : ${anu.source}`
				   	qiqi.sendMessage(from, buf, image, { quoted: freply, caption: `${texs}`})
				    break
		...
		//////if (!isRegistered) return reply( ind.noregis())
				...
				////////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					pok = await getBuffer(nimek)
					qiqi.sendMessage(from, pok, image, { quoted: freply })
					break
...
DilanUwu = `*[ SAMEHADAKU ]*\n\n\nJudul : ${anu.title}\nDesc : ${anu.desc}\nLink : ${anu.link}`
qiqi.sendMessage(from, buffer, image, {quoted: freply, caption: DilanUwu})
break
case `${prefix}neonime`:
//if (!isPublic) return reply(mess.only.publikG)
		//////if (!isRegistered) return reply( ind.noregis())
...
teks += `*Title* : ${i.judul}\n*Link* : ${i.link}\n*Release* : ${i.rilis}\n=====================\n`
		...
		//////if (!isRegistered) return reply( ind.noregis())
			    ...
			    qiqi.sendMessage(from, buffer, image, {quoted: freply, caption: QiqiBwuot})
			    break
		...
		//////if (!isRegistered) return reply( ind.noregis())
				...
				////////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, buffer, image, {quoted: freply, caption: hasil })
...
case `${prefix}brainly`:
		...
		//////if (!isRegistered) return reply( ind.noregis())
				...
				////////if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    ...
                    qiqi.sendMessage(from, thum, image, {quoted: freply, caption: `${anu.result}`})
                 	break
...
qiqi.sendMessage(from, home, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, getting, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}sad`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, sad1, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}sad2`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, sad2, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}sad3`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, sad3, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}sad4`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, sad4, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, tetik, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, tetik3, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, tetik4, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, allnight, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}lucas`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, lucas, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}sowell`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, well, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}wanna`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, wanna, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}up`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, ups, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, skin, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, moff, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, ful, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, gam, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, rest, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, date, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, kursi, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}tilawah`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, tilawah, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
...
qiqi.sendMessage(from, nabi, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}ngaji`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, ngaji1, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}ngaji2`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, ngaji2, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}iri`:
...
qiqi.sendMessage(from, irimp3, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break
case `${prefix}pale`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, pa, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break
case `${prefix}sound`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, soun, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break 
case `${prefix}sound1`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, satu, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break
case `${prefix}sound2`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, dua, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break
case `${prefix}sound3`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, tiga, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break
case `${prefix}sound4`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, empat, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break
case `${prefix}sound5`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, lima, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break
case `${prefix}sound6`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, enam, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break
case `${prefix}sound7`:
//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
qiqi.sendMessage(from, tujuh, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
break	
case `${prefix}slowmo`:
				//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
				...
				qiqi. sendMessage(from, uhh, audio, {mimetype: 'audio/mp4', ptt:true, quoted: freply})
				fs.unlinkSync(ran)
				})
				break
...
//funmenu
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, 'Pertanyaan : *'+bisakah+'*\n\nJawaban : '+ keh, text, { quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, 'Pertanyaan : *'+kapankah+'*\n\nJawaban : '+ koh, text, { quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, 'Pertanyaan : *'+apakah+'*\n\nJawaban : '+ kah, text, { quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, 'Pertanyaan : *'+bagaimanakah+'*\n\nJawaban : '+ mana, text, { quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, 'Pertanyaan : *'+rate+'*\n\nJawaban : '+ te+'%', text, { quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, 'Pertanyaan : *'+sange+'*\n\nJawaban : '+ nge+'%', text, { quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, 'Pertanyaan : *'+gayy+'*\n\nJawaban : '+ yag+'%', text, { quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, 'Pertanyaan : *'+lesbii+'*\n\nJawaban : '+ bi+'%', text, { quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, 'Pertanyaan : *'+ganteng+'*\n\nJawaban : '+ teng+'%', text, { quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, 'Pertanyaan : *'+cantik+'*\n\nJawaban : '+ tik+'%', text, { quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, 'Pertanyaan : *'+watak+'*\n\nJawaban : '+ tak, text, { quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, 'Pertanyaan : *'+hobby+'*\n\nJawaban : '+ by, text, { quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
					...
					setTimeout( () => {
					qiqibotwa.sendMessage(from, '*➸ Jawaban :* '+anu.result.jawaban+ '\n\n• Penjelasan: *'+ anu.result.deskripsi+'*', text, {quoted: freply}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
					qiqibotwa.sendMessage(from, '_10 Detik lagi…_', text) // ur cods
					}, 20000) // 1000 = 1s,
					setTimeout( () => {
					qiqibotwa.sendMessage(from, '_20 Detik lagi_…', text) // ur cods
					}, 10000) // 1000 = 1s,
					setTimeout( () => {
					qiqibotwa.sendMessage(from, '_30 Detik lagi_…', text) // ur cods
					}, 2500) // 1000 = 1s,
					setTimeout( () => {
					qiqibotwa.sendMessage(from, caklontong, text, {quoted: freply}) // ur cods
					}, 0) // 1000 = 1s,
		...
		////if (!isRegistered) return reply( ind.noregis())
					...
					setTimeout( () => {
					qiqibotwa.sendMessage(from, '*➸ Jawaban :* '+anu.result.jawaban, text, {quoted: freply}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
					qiqibotwa.sendMessage(from, '_10 Detik lagi…_', text) // ur cods
					}, 20000) // 1000 = 1s,
					...
					setTimeout( () => {
					qiqibotwa.sendMessage(from, family, text, {quoted: freply }) // ur cods
					}, 0) // 1000 = 1s,
		...
		////if (!isRegistered) return reply( ind.noregis())
					...
					setTimeout( () => {
					qiqibotwa.sendMessage(from, tebak, text, {quoted: freply})
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
					qiqibotwa.sendMessage(from, '_10 Detik lagi..._', text) // ur cods
					}, 20000) // 1000 = 1s,
					setTimeout( () => {
					qiqibotwa.sendMessage(from, '_20 Detik lagi..._', text) // ur cods
					}, 10000) // 1000 = 1s,
					setTimeout( () => {
					qiqibotwa.sendMessage(from, '_30 Detik lagi..._', text) // ur cods
					}, 2500) // 1000 = 1s,
					setTimeout( () => {
					qiqibotwa.sendMessage(from, ngebuff, image, { caption: '_Tebak bro!!! gak bisa jawab donasi ya:v_', quoted: freply }) // ur cods
					}, 0) // 1000 = 1s,
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, truteh, image, { caption: '*Truth*\n\n'+ ttrth, quoted: freply })
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, tod, image, { quoted: freply, caption: '*Dare*\n\n'+ der })
					
					break
//=====================================BATES NGAB=====================================\\
//Downloader menu
            case `${prefix}ambilthumb`: //by dilan
             ini_linku = args[0]
             
            helonpc = await fetchJson(`https://onlydevcity.herokuapp.com/api/ytthumbnail?url=${ini_linku}&apikey=${OnlyDev}`)
            
            bacot = await getBuffer(helonpc.result.maxresdefault)
            qiqi.sendMessage(from, bacot, image)
                        break
...
if (!mek.key.fromMe) return reply('Owner bukan?')
                   ...
                   //txt += `View : ${get_result.view}\n`
                    ...
                    qiqi.sendMessage(from, buffer, image, { quoted: freply, caption: txt })
                    //get_audio = await getBuffer(get_result.link[3].link)
                    //qiqi.sendMessage(from, get_audio, audio, { mimetype: 'audio/mp4', filename: `${get_result.title}.mp3`, quoted: freply })
                    break*/
              case `${prefix}ytmp3`:
			//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
...
if (!mek.key.fromMe) return reply('Owner bukan?')
                    ...
                    qiqi.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: freply })
                    break
//=====================================BATES NGAB=====================================\\
//RandomImagemenu
...
case `${prefix}wanted`:
	...
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	  ...
	  reply(ind.wait())
	  owgi = await qiqi.downloadAndSaveMediaMessage(ted)
	  tels = body.slice(7)
	  anu = await imgbb("3ea1465ef91578a90ee81f7d41c59a1f", owgi)
	  hehe = await getBuffer('https://videfikri.com/api/textmaker/wanted/?urlgbr=${anu.display_url}&text1=Dicari&text2=${tels}')
	 qiqi.sendMessage(from, hehe, image, {quoted: freply})
	} else {
...
case `${prefix}hedsot`:
					...
					if (mentioned.length > 1) {
						...
						qiqi.groupRemove(from, mentioned)
					} else {
...
//makermenu
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    if (args.length == 0) return reply(`Usage: ${prefix + command} text\nExample: ${prefix + command} DILAN`)
                    txt = args.join(" ")
                    reply(ind.wait())
                    buffer = await getBuffer(`https://videfikri.com/api/textmaker/${command}/?text=${txt}`)
                    qiqi.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan lupa follow ig @helonpc*', quoted: freply})
                break
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}anakharamserti QIQI-SELF*')
				reply(ind.wait())
				ct = body.slice(11)
				...
				break
				case `${prefix}nulis`:
                //❗case by QIQI-SELFBennyBot
                
               //if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())

                ////if (isBanned) return reply('Maaf kamu sudah terbenned!')
                if (args.length < 1) return reply('Teksnya mana ngab?\nContoh ${prefix}nulis QIQI-SELF')
                dapuhy = body.slice(7)
                reply(ind.wait())
                asu = await getBuffer(`http://zekais-api.herokuapp.com/bukukanan?text=${dapuhy}`)
                qiqi.sendMessage(from, asu, image, {caption: 'Nih Jan Lupa Subscribe QIQI-SELFBennyBot', quoted: freply})
                break
				case `${prefix}nulis2`:
                //❗case by QIQI-SELFBennyBot
                //if (!isPublic) return reply(mess.only.publikG)
		...
		////if (!isRegistered) return reply( ind.noregis())
                ...
                ////if (isBanned) return reply('Maaf kamu sudah terbenned!')
                if (args.length < 1) return reply('Teksnya mana ngab?\nContoh ${prefix}attp QIQI-SELF')
                dapuhy = body.slice(6)
				dapzz = await getBuffer(`https://api.xteam.xyz/attp?file&text=${dapuhy}`)
				qiqi.sendMessage(from, dapzz, sticker, {quoted: freply})
				break
                case `${prefix}ttp`:
                //❗case by QIQI-SELFBennyBot
...
break
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}googlesearch dilan|Benny|Banget')
				reply(ind.wait())
				ct = body.slice(14)
				dap1 = ct.split("/")[0];
                dap2 = ct.split("/")[1];
				...
				qiqi.sendMessage(from, buffer, image, { quoted: freply, caption: 'Nih Jangan Lupa Subscribe QIQI-SELF' })
				break
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}pubglogo dilan|Benny')
				reply(ind.wait())
				ct = body.slice(9)
				dap1 = ct.split("/")[0];
                dap2 = ct.split("/")[1];
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}glitchtext dilan|Benny')
				reply(ind.wait())
				ct = body.slice(11)
				dap1 = ct.split("/")[0];
                dap2 = ct.split("/")[1];
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return reply('Textnya Mana Cuy?\n*Contoh ${prefix}battlefield dilan|Benny')
				reply(ind.wait())
				ct = body.slice(12)
				dap1 = ct.split("/")[0];
                dap2 = ct.split("/")[1];
	...
	var itsme = `${numbernye}@s.whatsapp.net`
				var split = `${fake}`
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
					    ...
					    buff = await qiqi.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							qiqi.sendMessage(_.jid, buff, image, dilan1, {caption: `*BC GROUP*\n\n➸ *Dari Grup* : ${groupName}\n➸ *Pengirim* : wa.me/${(sender.split('@')[0])}\n➸ *Pesan* : ${body.slice(6)}\n\n *Nomer :* ${sender.replace('@s.whatsapp.net', '')}\n*Waktu :* *${moment.unix(int.timestamp).format('HH:mm:ss')} WIB*\n*Tanggal :* *${moment.unix(int.timestamp).format('DD/MM/YYYY')}*`})
						}
						reply('*SUKSES BOSKU*')
					} else {
						for (let _ of anu) {
				 ...
				 qiqi.chatRead (from)
					if (!isGroup) return reply(ind.groupo())
				if (!mek.key.fromMe) return reply('Owner bukan?')
					qiqi.blockUser (`${body.slice(7)}@c.us`, "add")
					qiqi.sendMessage(from, `*Perintah Diterima, Memblokir* ${body.slice(7)}@c.us`, text)
					break
		            case `${prefix}unblock`:
					//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
					...
					if (!isGroup) return reply(ind.groupo())
				if (!mek.key.fromMe) return reply('Owner bukan?')
				    qiqi.blockUser (`${body.slice(9)}@c.us`, "remove")
					qiqi.sendMessage(from, `*Perintah Diterima, Membuka Blockir* ${body.slice(9)}@c.us`, text)
					break
					case `${prefix}leave`:
                 // ⚠️ Case by QIQI-SELF
				//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
				...
				if (!mek.key.fromMe) return reply('Owner bukan?')
					setTimeout( () => {
					qiqi.groupLeave (from) 
					}, 2000)
					setTimeout( () => {
					qiqi.updatePresence(from, Presence.composing) 
					qiqi.sendMessage(from, 'Bye cuk🗣', text) // ur cods
					}, 0)
					break
case `${prefix}fitnah`:
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				if (!mek.key.fromMe) return reply('Owner bukan?')
					anu = await qiqi.chats.all()
					qiqi.setMaxListeners(25)
					for (let _ of anu) {
						qiqi.deleteChat(_.jtext)
					}
					reply(ind.clears())
					break
					case `${prefix}setprefix`:
		...
		////if (!isRegistered) return reply( ind.noregis())
					...
					break 
		            //
					case `${prefix}addbadword`:  // Fix Bug By dilan*
					//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				qiqi.blockUser (`${body.slice(10)}@c.us`, "remove")
                qiqi.sendMessage(from, `*Perintah Diterima, Membuka Blockir* ${body.slice(9)}@c.us`, text)
                break
		        case `${prefix}block`:
...
//InformationMenu
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				qiqi.sendMessage(from, hasil, text, {quoted: freply})
				break
				case `${prefix}kbbi`:	
                //if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				qiqi.sendMessage(from, teks, text, {quoted: freply, caption: 'Nih hasilnya kak...'})
				break
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				qiqi.sendMessage(from, teks, text, {quoted: freply})
				break
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				////if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					qiqi.sendMessage(from, ca, text, {quoted: freply })
...
//nsfwmenu
			...
			//	if (!isUser) return reply(mess.only.userB)
				//if (!isPublic) return reply(mess.only.publikG)
				 data = fs.readFileSync('./qiqibot/18.js');
                 ...
                 qiqi.sendMessage(from, randBokep, image, {quoted: freply, caption: randTeks})
...
////if (!isRegistered) return reply( ind.noregis())
			...
			//	if (!isUser) return reply(mess.only.userB)
				//if (!isPublic) return reply(mess.only.publikG)
				reply(mess.wait)
				 data = fs.readFileSync('./qiqibot/asupan.js');
                 jsonData = JSON.parse(data);
                 randIndex = Math.floor(Math.random() * jsonData.length);
                 randKey = jsonData[randIndex];
                 asupan = await getBuffer(randKey.result)
                 qiqi.sendMessage(from, asupan, video, {quoted: freply, caption: '\`\`\`ASUPAN GAN:V\`\`\`'})
				//await limitAdd(sender) 
				break  
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				buffer = await getBuffer(anu.result.url)
				qiqi.sendMessage(from, buffer, image, {quoted: freply, caption: 'Nih hasilnya kak...'})
				break
		...
		////if (!isRegistered) return reply( ind.noregis())
				...
				buffer = await getBuffer(anu.result.url)
				qiqi.sendMessage(from, buffer, image)
				break
		        case `${prefix}baka`: 
		//if (!isNsfw) return reply(ind.nsfwoff())
		//if (!isPublic) return reply(mess.only.publikG)
		////if (!isRegistered) return reply( ind.noregis())
				...
				qiqi.sendMessage(from, buffer1, image)
				break
		        case `${prefix}blowjob`: 
		//if (!isNsfw) return reply(ind.nsfwoff())
		//if (!isPublic) return reply(mess.only.publikG)
...
case `${prefix}grup`:
              ...
              ////
                ...
                qiqi.groupSettingChange(from, GroupSettingChange.messageSend, false)
                } else if (args[0] === 'tutup') {
                reply(`*BERHASIL MENUTUP GROUP*`)
				qiqi.groupSettingChange(from, GroupSettingChange.messageSend, true)
                }
                break
case `${prefix}setname`:
		        if (!isGroup) return reply(ind.groupo())
				//
				if (!isBotGroupAdmins) return reply(ind.badmin())
				qiqi.groupUpdateSubject(from, `${body.slice(9)}`)
				qiqi.sendMessage(from, 'Succes, Ganti Nama Grup', text, {quoted: freply})
				break
                case `${prefix}setdesc`:
                if (!isGroup) return reply(ind.groupo())
              ////
                if (!isBotGroupAdmins) return reply(ind.badmin())
                qiqi.groupUpdateDescription(from, `${body.slice(9)}`)
                qiqi.sendMessage(from, 'Succes, Ganti Deskripsi Grup', text, {quoted: freply})
                break
                case `${prefix}demote`:
                if (!isGroup) return reply(ind.groupo())
              ////
                ...
                mentions(teks, mentioned, true)
                qiqi.groupDemoteAdmin(from, mentioned)
                } else {
              ...
              ////
                ...
                mentions(teks, mentioned, true)
                qiqi.groupMakeAdmin(from, mentioned)
                } else {
...
case `${prefix}spam|5`:
			...
			//	//if (!isRegistered) return reply(ind.noregis())
				//if (!isPrem) return reply(ind.premium())
					...
					qiqi.sendMessage(from, options, text)
	                .then(() => {qiqi.sendMessage(from, options, text)})
	                .then(() => {qiqi.sendMessage(from, options, text)})
	                .then(() => {qiqi.sendMessage(from, options, text)})
	                .then(() => {qiqi.sendMessage(from, options, text)})
					break
   ...
   case `${prefix}owner`:
            ...
            qiqi.sendMessage(from, {displayname: "Dilanツ", vcard: vcard1}, MessageType.contact, { quoted: freply})
             
              qiqi.sendMessage(from, 'Tuh nomer owner ku 😎 jangan spam goblog atau gw block lu',MessageType.text, { quoted: freply} )
		break
                    case `${prefix}kangbanned`:
            
             qiqi.sendMessage(from, {displayname: "Whatsappツ", vcard: vcard2}, MessageType.contact, { quoted: freply})
           
		break

case `${prefix}colong`:
                    if ((isMedia && !qiqi.message.videoMessage || isQuotedSticker)) {
                        const encmedia = isQuotedSticker ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
                        filePath = await qiqi.downloadAndSaveMediaMessage(encmedia, filename = getRandom());
                        ...
                        request({
                            ...
                            qiqi.sendMessage(from, ini_buff, sticker, { quoted: freply })
...
// //if (!isRegistered) return reply(ind.wait())
           ...
           ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
           reply(ind.wait)
         owgi = await qiqi.downloadAndSaveMediaMessage(ger)
           anu = await imgbb("08579d070df9a07cb1c2ee565aece767", owgi)
       ...
       exec(`wget ${anu1} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
                                                ...
                                                qiqi.sendMessage(from, nobg, sticker, {quoted: freply})
                                                fs.unlinkSync(rano)
                                        })
...
if (err) return reply(mess.error.stick)
nobg = fs.readFileSync(rano)
qiqi.sendMessage(from, nobg, sticker, {
  quoted: freply
})
fs.unlinkSync(rano)
  })
...
break
		...
		//		//if (!isRegistered) return reply(ind.noregis())
			//	if (!isPrem) return reply(ind.premium())
				...
				qiqi.sendMessage(from, buffer, image, {quoted: freply})
			//	await limitAdd(sender)
				break				
				case `${prefix}hartatahta`:
			//	 if (!isPrem) return reply(ind.premium())				
			...
			//	//if (isBanned) return reply('Maaf kamu sudah terbenned!')
				...
				qiqi.sendMessage(from, bh, image, {caption: 'Nih kak udah jadi..', quoted: freply})
			//	await limitAdd(sender)
				break
...
case `${prefix}speed`:
                ...
                qiqi.sendMessage(from, `Speed: ${latensi.toFixed(4)} _ms_`, text, { quoted: freply})
                    break		
...
// Fitur Defacer
			...
			//	if (!isUser) return reply(mess.only.userB)
				...
				qiqi.sendMessage(from, `${anu.result}`, text, {quoted: freply})
			...
			//	if (!isUser) return reply(mess.only.userB)
				...
				////if (isLimit(sender)) return reply(limitend(pushname2))
					  ...
					  qiqi.sendMessage(from, hasilhash, text, {quoted: freply})
...
// akhir encrypt & decrypt Fitur
			...
			//	if (!isUser) return reply(mess.only.userB)
                ...
                for (let i = 0; i < results.length; i++) {
                    ...
                    console.log(e)
                    qiqi.sendMessage(from, 'Google Error : ' + e);
                })
...
case `${prefix}kalkulator`:
				 ...
				 //  if (!isUser) return reply(mess.only.userB)
				   ...
				   //if (isLimit(sender)) return reply(limitend(pushname2))
				    ...
				    qiqi.sendMessage(from, `*${anu.result.data}*`, text, {quoted: freply})
                ...
                if (!isGroup) return reply(mess.only.group)
                try {
					ppUrl = await qiqi.getProfilePicture(from)
					} catch {
					ppUrl = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
					}
                reply(mess.wait) // leave empty to get your own
			    buffer = await getBuffer(ppUrl)
		        qiqi.sendMessage(from, buffer, image, {quoted: freply, caption: `*NAME* : ${groupName}\n*MEMBER* : ${groupMembers.length}\n*ADMIN* : ${groupAdmins.length}\n*DESK* : ${groupDesc}`})
                break
case `${prefix}setpp`:
	            //if (isBanned) return reply('Maaf kamu sudah terbenned!')    
	           // if (!isUser) return reply(mess.only.userB)
	            //if (!isPublic) return reply(mess.only.publikG)
                  ...
                  //  if (!isGroupAdmins) return reply(mess.only.admin)
                    ...
                    enmedia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
                    media = await qiqi.downloadAndSaveMediaMessage(enmedia)
                    await qiqi.updateProfilePicture (from, media)
                    reply('sabar')
...
case `${prefix}infoowner`:
					   ...
					   qiqi.sendMessage(from, infown(), text)
					   break
					   case `${prefix}bahasa`:
					// Fix Case By dilan⛔
					...
					qiqi.sendMessage(from, bahasa(), text)
					...
					qiqi.sendMessage(from, negara(), text)
					...
					qiqi.deleteMessage(from, { id: mek.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true })
...
break
                ...
                const saya = '6289510048004@c.us'
                arg = body.trim().split('|')
                qiqi.sendMessage(from, `otw mek`, MessageType.text, {quoted : freply})
                const gcname = args[1]
                qiqi.groupCreate(gcname, saya)
                qiqi.sendMessage(from, 'Group Created')
                break

case `${prefix}meme`:
					meme = await fetchJson('https://kagchi-api.glitch.me/meme/memes', { method: 'get' })
					buffer = await getBuffer('https://imgur.com/${meme.hash}.jpg')
					qiqi.sendMessage(from, buffer, image, {quoted: freply, caption: '.......'})
					break
...
break
				...
				reply(ind.wait())
                 ...
                 qiqi.sendMessage(from, darkjokes, image, {quoted: freply, caption: '\`\`\`DARK JOKES\`\`\`'})
				break
				...
				case `${prefix}newsinfo`: 
					...
					nimek =  n[Math.floor(Math.random() * n.length)];
					pok = await getBuffer(nimek)
					qiqi.sendMessage(from, pok, image, { quoted: freply, caption: `*PINTEREST*`})
			...
			//	    if (isLimit(sender)) return reply(ind.limitend(pusname))
                    if ((isMedia && !mek.message.videoMessage || isQuotedImage)) {
                        ...
                        request({
                            ...
                            qiqi.sendMessage(from, buffer, sticker, { quoted: freply})
                            fs.unlinkSync(file_name)
                        });
                    } else {
...
//islammenu
				...
				qiqi.sendMessage(from, buffer7, image, {quoted: freply, caption: teks})
				break
...
/*case `${prefix}antilink`:
			...
			//	if (!isGroupAdmins) return reply(mess.only.admin)
				...
				qiqi.sendMessage(from,`Perhatian kepada seluruh member anti link group aktif apabila anda mengirim link group anda akan di kick dari group`, text)
				} else if (Number(args[0]) === 0) {
                ...
                if (Number(args[0]) === 1) {
                    ...
                    fs.writeFileSync('./lib/milea/autostiker.json', JSON.stringify(_autostiker))
...
case `${prefix}fake`:
 ...
 case `${prefix}tinyurl`:
					...
					axios.get(`https://tobz-api.herokuapp.com/api/tinyurl?url=${tinyurl}&apikey=${TobzKey}`).then((res) => {
						...
						qiqi.sendMessage(from, hasil, MessageType.text, srotlink)
				})
				break
...
dung = (anu.sticker)
qiqi.sendMessage(from, buffer, image, {quoted: freply, caption: teks})
...
qiqi.sendMessage(from, buffer, image, {quoted: freply, caption: 'Nih'})
break
					...
					.on('exit', () => {
						imgbb("6e930040217770526ad1091c102d652a", './temp/ttp.png').then(res => {
							...
							exec(`wget ${trig} -O ${trip} && ffmpeg -i ${trip} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${trio}`, (err) => {
								...
								qiqi.sendMessage(from, olab, sticker, {quoted: freply})
								fs.unlinkSync(trio)
							})
						})
					})
...
case `${prefix}nasa.gov`:
					...
					var path = require('path')
					var { spawn } = require('child_process')
					const ushname1 = mek.key.fromMe ? qiqi.user.name : conts.notify || conts.vname || conts.name || '-'
					...
					.on('exit', () => {
						imgbb("6e930040217770526ad1091c102d652a", './temp/ttp.png').then(res => {
							...
							exec(`wget ${trig} -O ${trip} && ffmpeg -i ${trip}`, (err) => {
								olab = fs.readFileSync(trip)
								qiqi.sendMessage(from, olab, MessageType.image, {quoted: freply})
								fs.unlinkSync(trip)
							})
						})
					})
...
//======================================================================================================================================================================================================================================
        default:
            ...
            console.log(color('[QiqiBwuot]', 'blue'), 'Any Message ? ', color(sender.split('@')[0]))
          	}
          }
    	} catch (e) {
      console.log('Error : %s', color(e, 'red'))
